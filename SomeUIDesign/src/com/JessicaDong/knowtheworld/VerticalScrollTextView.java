...
public class VerticalScrollTextView extends TextView{
	...
	public int index = 0;
	private List<Scentence1> list;
	public float mTouchHistoryY;
	private int mY;	
	private float middleY;// y轴中间
	private static final int DY = 150; // 每一行的间隔
	...
	private void init() {
		setFocusable(true);
		if(list==null){
			list=new ArrayList<Scentence1>();
			Scentence1 sen=new Scentence1(0,"暂时没有通知公告");
			list.add(0, sen);
		}		
	...
	public List<Scentence1> getList() {
		return list;
	}
	
	public void setList(List<Scentence1> list) {
		this.list = list;
	}
