...
/*
 * 这个MainActivity实现tab随viewpager�?��滑动
 */
public class MainActivity1 extends FragmentActivity{
	...
	//圆点图片集合
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			mFragmentAdapter = new FragmentAdapter(MainActivity1.this, getSupportFragmentManager());

			mfViewPager = (ViewPager) findViewById(R.id.pager);
			mfViewPager.setAdapter(mFragmentAdapter);
			mfViewPager.setCurrentItem(60); //80�ĳ���60
...
//		}
		...
		public void showWindow2(View v) {
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			    	...
			    	case 0: 
			    	{
			    		Intent it1 = new Intent(MainActivity1.this, Friendadd.class);
			    		startActivity(it1);break;
			    	}
			    	case 1: 
			    	{
			    		Intent it2 = new Intent(MainActivity1.this, Friendmanagement.class);
			    		startActivity(it2);break;
			    	}
			    	case 2: 
			    	{
			    		Intent it3 = new Intent(MainActivity1.this, Release2.class);
		...
		public void showWindow3(View v) {
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			    	...
			    	case 0: 
			    	{
			    		Intent it1 = new Intent(MainActivity1.this,Angela.class);
			    		startActivity(it1);break;
			    	}
			    	case 1: 
			    	{
			    		Intent it2 = new Intent(MainActivity1.this, Mycomment.class);
			    		startActivity(it2);break;
			    	}
			    	case 2: 
			    	{
			    		Intent it3 = new Intent(MainActivity1.this, Recntlyview.class);
			    		startActivity(it3);break;
			    	}
			    	case 4: 
			    	{
			    		Intent it3 = new Intent(MainActivity1.this, Feedback.class);
			    		startActivity(it3);break;
			    	}
			    	case 3: 
			    	{
			    		Intent it3 = new Intent(MainActivity1.this, Seetings.class);
			    		startActivity(it3);break;
			    	}
			    	};
					popupWindow.dismiss();
		...
		public void showWindow5(View v) {
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			    	...
			    	case 4:
			    	{
			    		Intent it1 = new Intent(MainActivity1.this,CityList.class);	
	...
	//Intent it = new Intent(TestWeiXinWhatsNewActivity.this,Searchtext1.class);
			Intent it = new Intent(MainActivity1.this,Sear.class);	
			startActivity(it);
		...
		public void friclick1(View v)
		{
			...
			Intent it = new Intent(MainActivity1.this,Release.class);	
			startActivity(it);
			//MainActivity.this.finish();
		}
		public void friclick2(View v)
		{
			...
			Intent it = new Intent(MainActivity1.this,Share.class);	
			startActivity(it);
			//MainActivity.this.finish();
		}
		public void friclick3(View v)
		{
			...
			Intent it = new Intent(MainActivity1.this,Comment.class);	
			startActivity(it);
			//MainActivity.this.finish();
		}
		public void hotclick1(View v)
		{
			...
			Intent it = new Intent(MainActivity1.this,VerticalScrollTextActivity1.class);	
			startActivity(it);
			//MainActivity.this.finish();
		}
		public void catclick1(View v)
		{
			...
			Intent it = new Intent(MainActivity1.this,Catdetail.class);	
			startActivity(it);
			//MainActivity.this.finish();
		}
		public void catclick2(View v)
		{
			...
			Intent it = new Intent(MainActivity1.this,Hot2.class);	
			startActivity(it);
			//MainActivity.this.finish();
		}
		...
		{
			Intent it1 = new Intent(MainActivity1.this,Me1.class);	
			startActivity(it1);
		}
		public void colclick2(View v)
		{
			Intent it1 = new Intent(MainActivity1.this,Me2.class);	
			startActivity(it1);
		}
		public void colclick3(View v)
		{
			Intent it1 = new Intent(MainActivity1.this,Me3.class);	
			startActivity(it1);
		}
		public void colclick4(View v)
		{
			Intent it1 = new Intent(MainActivity1.this,Me4.class);	
			startActivity(it1);
		}
		public void colclick5(View v)
		{
			Intent it1 = new Intent(MainActivity1.this,Me5.class);	
			startActivity(it1);
		}
		public void colclick6(View v)
		{
			Intent it1 = new Intent(MainActivity1.this,Me6.class);	
			startActivity(it1);
		}
		public void colclick7(View v)
		{
			Intent it1 = new Intent(MainActivity1.this,Me7.class);	
			startActivity(it1);
		}
